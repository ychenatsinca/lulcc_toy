...
####################################################################################################
fun_lulcc_toy <- function(ld_plot=TRUE, c_value=100, f_top=0.15,nx=100,ny=100, f_demo=0.00008, agb_ratio = 0.25,
                          geo_city=data.frame(lon_x=c(78,80,50,20,10),lat_y=c(48,35,75,65,40)),
...
#one Taipei-city only
fun_lulcc_toy(geo_city=data.frame(lon_x=c(50),lat_y=c(75)) )  

# three cites
#fun_lulcc_toy(geo_city=data.frame(lon_x=c(50,78,20),lat_y=c(75,48,65)) )
